...
Set TBMaquinas = BD.OpenRecordset("Select * from cadmaquinas where maquina = '" & cmbmaquina.Text & "'")
If TBMaquinas.EOF = False Then
    Set TBordemservico = BD.OpenRecordset("Select * from ordemservico where idproducao = " & frmProducao_CB.txtos.Text & "")
    If TBordemservico.EOF = False Then
        TBordemservico.Edit
        TBordemservico!Maquina = cmbmaquina.Text
        frmProducao_CB.txtmaquina.Text = cmbmaquina.Text
        TBordemservico.Update
    End If
    TBordemservico.Close
End If
TBMaquinas.Close
frmProducao_CB.procAtualizaProducao
...
Set TBMaquinas = BD.OpenRecordset("Select * from CadMaquinas where maquina = '" & cmbmaquina.Text & "' and liberada = false and OS <> " & frmProducao_CB.txtos.Text & "")
If TBMaquinas.EOF = False Then
