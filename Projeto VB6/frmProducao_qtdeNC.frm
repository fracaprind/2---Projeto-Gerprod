...
Begin VB.Form frmProducao_qtdeNC 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Gerprod | Informe itens não conforme"
   ClientHeight    =   10575
   ClientLeft      =   0
   ClientTop       =   30
   ClientWidth     =   6540
   ...
   EndProperty
   Icon            =   "frmProducao_qtdeNC.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   11536
      _ExtentY        =   953
      DibPicture      =   "frmProducao_qtdeNC.frx":0E42
      CaptionDelimiter=   "|"
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frmProducao_qtdeNC.frx":82E7
      IconSize        =   1
      IconSizeX       =   24
      IconSizeY       =   24
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Cmd_backspace 
         ...
         Left            =   825
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":9139
         Style           =   1  'Graphical
         TabIndex        =   15
         TabStop         =   0   'False
         Top             =   1800
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   285
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":9443
         Style           =   1  'Graphical
         TabIndex        =   14
         TabStop         =   0   'False
         Top             =   1800
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   1335
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":974D
         Style           =   1  'Graphical
         TabIndex        =   13
         TabStop         =   0   'False
         Top             =   1260
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   825
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":9A57
         Style           =   1  'Graphical
         TabIndex        =   12
         TabStop         =   0   'False
         Top             =   1260
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   285
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":9D61
         Style           =   1  'Graphical
         TabIndex        =   11
         TabStop         =   0   'False
         Top             =   1260
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   1335
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":A06B
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
         Top             =   750
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   825
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":A375
         Style           =   1  'Graphical
         TabIndex        =   9
         TabStop         =   0   'False
         Top             =   750
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   285
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":A67F
         Style           =   1  'Graphical
         TabIndex        =   8
         TabStop         =   0   'False
         Top             =   750
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   1335
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":A989
         Style           =   1  'Graphical
         TabIndex        =   7
         TabStop         =   0   'False
         Top             =   240
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   825
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":AC93
         Style           =   1  'Graphical
         TabIndex        =   6
         TabStop         =   0   'False
         Top             =   240
      ...
      Begin VB.CommandButton Number 
         ...
         Left            =   285
         MaskColor       =   &H00404040&
         MouseIcon       =   "frmProducao_qtdeNC.frx":AF9D
         Style           =   1  'Graphical
         TabIndex        =   5
         TabStop         =   0   'False
         Top             =   240
   ...
   End
End
Attribute VB_Name = "frmProducao_qtdeNC"
...
TOTALOK = frmProducao.ListaOS.ListItems.Item(1).ListSubItems.Item(4).Text
TOTALOK = TOTALOK - frmProducao.ListaOS.ListItems.Item(1).ListSubItems.Item(14).Text
txtTOK = TOTALOK - TotalNaoconforme
End If
